...
def calculate_demographic_data(print_data=True):
    ...
    num_bachelors = (df['education'] == 'Bachelors').sum()
    ...
    country_rich_share = country_rich_count / country_count * 100

    highest_earning_country = country_rich_share.idxmax()
    highest_earning_country_percentage = round(country_rich_share.max(), 1)
    ...
    if print_data:
        ...
        print(f"Number of people who work minimum hours: {num_min_workers}")
